...
type menus = Game | Level

let levelMenu width height  =
    let lvl0 = Tetronimo.createWith Tetronimo.I Color.AliceBlue 3 3 0.08
    Tetronimo.draw lvl0

let draw width height menu =
    match menu with
    | menu when menu = Level -> levelMenu width height
    | _ -> ()
